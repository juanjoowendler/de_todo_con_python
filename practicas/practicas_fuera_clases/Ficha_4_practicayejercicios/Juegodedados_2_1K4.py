...
# SI LOS DOS NOMBRES SON IGUALES
...
# PRIMER JUGADOR LANZA LOS DADOS
...
# SEGUNDO JUGADOR LANZA LOS DADOS
...
if sumatoria % 2 == 0 and eleccion_jugador_1 == "par":
    acum_punt_jug_1 = acum_punt_jug_1 + max(dado_1,dado_2,dado_3)
    print("\t",jugador_1, "suma:",max(dado_1,dado_2,dado_3),"puntos")
else:
    if sumatoria % 2 != 0 and eleccion_jugador_1 == "impar":
        print("La sumatoria es impar", sumatoria, "es impar. Sumas: ", max(dado_1,dado_2,dado_3))
        acum_punt_jug_1 = acum_punt_jug_1 + max(dado_1,dado_2,dado_3)
    else:
        acum_punt_jug_1 = acum_punt_jug_1 - min(dado_1,dado_2,dado_3)
        print("\t",jugador_1, "resta:", min(dado_1,dado_2,dado_3),"puntos")



# DUPLICACION DE PUNTOS SI HAY PARIDAD EN LOS DADOS
...
if sumatoria % 2 == 0 and eleccion_jugador_2 == "par":
    acum_punt_jug_2 = acum_punt_jug_2 + max(dado_1,dado_2,dado_3)
    print("\t",jugador_2, "suma:",max(dado_1,dado_2,dado_3),"puntos")
else:
    if sumatoria % 2 != 0 and eleccion_jugador_2 == "impar":
        print("La sumatoria es impar", sumatoria, "es impar. Sumas: ", max(dado_1,dado_2,dado_3))
        acum_punt_jug_2 = acum_punt_jug_2 + max(dado_1,dado_2,dado_3)
    else:
        acum_punt_jug_2 = acum_punt_jug_2 - min(dado_1,dado_2,dado_3)
